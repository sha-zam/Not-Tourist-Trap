...
//retrieve past booking for tours
$bookingDetails = GuideController::retrieveBooking($tourID);

//check review
$review = tourReviewController::retrieveReview($bookingDetails[3]);
$reviewerID = $bookingDetails[0];
$reviewerName = $bookingDetails[1].' '.$bookingDetails[2];
    ...
    <header class="jumbotron jumbotron-fluid">
        ...
        <div class="card">
            ...
            <div id="tourEndBody" class="card-body text-center">
                <h4 class="card-text">Review By : <a href ='./profileView.php?user=<?php echo $reviewerID?>'><?php echo $reviewerName?></a></h4>
                <h4 class="card-text"><?php echo str_repeat("⭐", $review->getRating()); ?></h4>
